...
Here is a DeviceEditor .xml design file that you can use to quickly recapitulate the design described below in DeviceEditor: [Combinatorial_SLIC_Gibson_CPEC_example.xml](http://j5.jbei.org/j5manual/attachments/Combinatorial_SLIC_Gi0.xml)
